      ...
      const options = {
        ...
        handler: async function (response) {
          try {
            ...
            const message = `
      Booking Successful: ${response.razorpay_payment_id}\n\n
    ...
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      ...
      >
        <Typography variant="h4" align="center" gutterBottom>
          Book Your <span style={{ color: "#0fb719" }}>Turf</span>
        </Typography>
                ...
                {timeSlots.map((slot, index) => (
                  <Button
                    ...
                    sx={{
                      ...
                      minWidth: '80px',
                      textAlign: 'center',
                      backgroundColor: isHighlighted(slot) || isToHighlighted(slot) ? '#0fb719' : '',
                      color: isHighlighted(slot) || isToHighlighted(slot) ? '#000000' : '',
                    }}
                  >
                    {slot}
                  </Button>
